...
/*IR Hispanic ethnicity*/
	((cum_MDRO_hisp / &hisp_yes) * 100000) as IR_cum_MDRO_hisp "Cumulative IR MDRO in Quarter: Hispanic" format=10.2,
	((cum_MDRO_nohisp / &hisp_no) * 100000) as IR_cum_MDRO_nohisp "Cumulative IR MDRO in Quarter: Not Hispanic" format=10.2,
	((cum_MDRO_unkhisp / &state_pop) * 100000) as IR_cum_MDRO_unkhisp "Cumulative IR MDRO in Quarter: Unknown Hispanic" format=10.2,
	((cum_MDRO_misshisp / &state_pop) * 100000) as IR_cum_MDRO_misshisp "Cumulative IR MDRO in Quarter: Missing Hispanic" format=10.2,

/*IR Gender*/
	((cum_MDRO_male / &male_pop) * 100000) as IR_cum_MDRO_male "Cumulative IR MDRO in Quarter: Male" format=10.2,
	((cum_MDRO_female / &female_pop) * 100000) as IR_cum_MDRO_female "Cumulative IR MDRO in Quarter: Female" format=10.2,
	((cum_MDRO_sexmiss / &state_pop) * 100000) as IR_cum_MDRO_sexmiss "Cumulative IR MDRO in Quarter: Missing" format=10.2,


/*IR Age*/
	((cum_MDRO_04 / &age_04) * 100000) as IR_cum_MDRO_04 "Cumulative IR MDRO in Quarter: Age 0-4" format=10.2,
	((cum_MDRO_0517 / &age_0517) * 100000) as IR_cum_MDRO_0517 "Cumulative IR MDRO in Quarter: Age 5-17" format=10.2,
	((cum_MDRO_1824 / &age_1824) * 100000) as IR_cum_MDRO_1824 "Cumulative IR MDRO in Quarter: Age 18-24" format=10.2,
	((cum_MDRO_2549 / &age_2549) * 100000) as IR_cum_CMDRO_2549 "Cumulative IR MDRO in Quarter: Age 25-49" format=10.2,
	((cum_MDRO_5064 / &age_5064) * 100000) as IR_cum_MDRO_5064 "Cumulative IR MDRO in Quarter: Age 50-64" format=10.2,
	((cum_MDRO_65 / &age_65) * 100000) as IR_cum_MDRO_65 "Cumulative IR MDRO in Quarter: Age 65+" format=10.2
...
select
	...
	(svi_hi_sum / &svihighpop) *100000 as svihigh_ir "Risk Index Greater than or equal to 0.80 IR"format=10.2,
	(svi_lo_sum / &svilowpop) *100000 as svilo_ir "Risk Index Less than 0.80 IR"format=10.2,
	...
	(svi_lo_oth / &svilowother) *100000 as svilow_ir_oth "Risk Index < 0.80 IR, Race: Other/Two or More Races"format=10.2, /*Two or more racs in census track data*/
...
select
	...
	Col1 as ir_val "&qtr_num IR/100K",
		/*add CI*/
	(ir_val * 1.05) as uCL "Upper confidence limit" format 10.2,
	(ir_val * 0.95) as lCL "Lower confidence limit" format 10.2
